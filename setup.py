...
print("Installing fa3 package (fastest forceatlas3 python implementation)\n")
...
if USE_CYTHON:
    ext_modules = [Extension('fa3.fa3util', ['fa3/fa3util.py', 'fa3/fa3util.pxd'], cython_directives={'language_level' : 3})]
    cmdclass = {'build_ext': build_ext}
    opts = {"ext_modules": ext_modules, "cmdclass": cmdclass}
elif path.isfile(path.join(here, 'fa3/fa3util.c')):
    print("Yes\n")
    ext_modules = [Extension('fa3.fa3util', ['fa3/fa3util.c'])]
    cmdclass = {}
    opts = {"ext_modules": ext_modules, "cmdclass": cmdclass}
else:
    print("Pre-generated C files are not available. This library will be slow without Cython optimizations.\n")
    opts = {"py_modules": ["fa3.fa3util"]}
...
setup(
    name='fa3',
    version='0.3.5',
    description='The fastest ForceAtlas3 algorithm for Python (and NetworkX)',
    long_description_content_type='text/markdown',
    long_description=long_description,
    author='Bhargav Chippada; Adapted to 3d Cesar Costa',
    author_email='bhargavchippada19@gmail.com;cescosta@gmail.com',
    ...
    keywords=['forceatlas3', 'networkx', 'force-directed-graph', 'force-layout', 'graph'],
    packages=['fa3'],
    classifiers=[
