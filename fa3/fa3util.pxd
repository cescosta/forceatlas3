...
# is associated with the fa3util.py file.
#
# IF ANY CHANGES ARE MADE TO fa3util.py, THE CHANGES MUST BE REFLECTED
# HERE!!
#
...
cdef class Node:
    ...
    cdef public double old_dx, old_dy, old_dz
...
cdef class Region:
    ...
    @cython.locals(n = Node,
                   ...
                   frontleftNodes = list,
                   backleftNodes = list,
                   frontrightNodes = list,
                   backrightNodes = list,
                   upfrontleftNodes = list,
                   downfrontleftNodes = list,
                   upfrontrightNodes = list,
                   downfrontrightNodes = list,
                   upbackrightNodes = list,
                   downbackrightNodes = list,
                   upbackleftNodes = list,
                   downbackleftNodes = list,
                   subregion = Region)
